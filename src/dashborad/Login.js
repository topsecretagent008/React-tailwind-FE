            ...
            <div className='w-[60%] py-[39px] px-[32px] justify-center'>
                <div className='flex w-full'>
                    ...
                    <div className='ml-[55%] flex'>
                        <div className='px-[5px] py-[15px] text-center justify-center text-[16px]'>Don't Have Account</div>
                        <Link className='bg-[#edb731] text-[16px] px-[36.5px] py-[14px] rounded-full' to='/signup'>Singup Now</Link>
                    </div>
                </div>
                <div className='justify-center px-[39px] py-[39px] mx-[46px] my-[150px] border-2 borderr-black rounded-xl'>
                    <div className='text-start text-[20px] mb-[24px]'>Login</div>
                    ...
                    <div className='px-[117px] text-center pt-[35px]'>
                        <button className='bg-[#edb731] text-[16px] mb-[35px] px-[46.5px] py-[6px] rounded-full'>Login</button>
