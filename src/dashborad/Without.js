    ...
    return (
        <div className="w-full flex text-center ">
            <div className="px-[50px] py-[30px] text-center justify-center w-[20%] bg-[#222222] text-[17px]">
                ...
                <button className="px-[35%] py-[6px] bg-[#edb731]  mt-[200px] my-[30px] border-2 border-[#edb731] rounded-full">Login</button>
                <button className="px-[35%] py-[6px] border-[#edb731] text-[#edb731] border-2 rounded-full">Signup</button>
            </div>
